...
import com.vadim.devops.llm.LlmCallObservationHandler;
...
public class LlmConfig {
    ...
    @Bean
    SmartInitializingSingleton llmCallCounterRegistrar(ObservationRegistry observationRegistry,
                                                       TokenUsageTracker tokenUsageTracker) {
        return () -> observationRegistry.observationConfig()
                .observationHandler(new LlmCallObservationHandler(tokenUsageTracker));
    }
